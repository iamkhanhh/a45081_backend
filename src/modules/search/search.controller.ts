import { Controller, Post, Body, Request, Query, ParseIntPipe, DefaultValuePipe } from '@nestjs/common';
...
export class SearchController {
    ...
    @ApiOperation({
        ...
        description: 'Search by name to find matching samples, workspaces, and analysis'
    })
